    ...
    "paths": {
        ...
        "/healthcheck": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Returns status, environment, and version",
                        "schema": {
                            "type": "object",
        ...
        "/users/feed": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Offset the number of posts returned",
                        "name": "offset",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Sort the posts by created_at in ascending or descending order",
                        "name": "sort",
                        "in": "query"
                    }
                ],
